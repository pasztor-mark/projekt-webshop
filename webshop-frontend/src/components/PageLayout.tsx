  ...
  return (
    <>
      <SidebarProvider>
        ...
        <main
          data-vaul-wrapper
          className="bg-gradient-to-br mx-auto dark:from-neutral-950 from-neutral-50 px-3 dark:to-stone-900 to-stone-200 min-h-screen w-11/12 "
        >
          <SidebarTrigger className=" p-5 ml-2 bg-emerald-500 rounded-full fixed bottom-4" />
          {isAuthenticated ? (
            <Outlet context={{ user: fetchedUser }} />
          ) : (
