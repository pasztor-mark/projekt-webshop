...
import { FaCartArrowDown, FaCartPlus, FaCheckDouble, FaPencil } from "react-icons/fa6";
import { useEffect, useState } from "react";

export default function GuideCard({ guide, user }: { guide: GuideWithAuthor, user: User }) {
    ...
    <Card className="flex flex-col">
      ...
      <CardFooter className="basis-2/12 flex flex-col">
        ...
        {isPurchased ? (
          ...
          <Button className="w-full border-emerald-500" variant={"outline"}
